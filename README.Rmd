...
**So far, the package has not yet been submitted to CRAN.** The development version is available from [GitHub](https://github.com/piusdahinden/expirest). Installation from this source is easily done by using `install_github()` function from the `devtools` package:
