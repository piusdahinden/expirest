...
#' of five batches obtained over a 24 months period of a drug product. A total
#' of \eqn{n = 53} independent measurements are available (corresponding to
#' data shown in Tables IV, VI and VIII in LeBlond \emph{et al}). Data in Table
#' IV of LeBlond \emph{et al} (batches \code{b2}, \code{b5} and \code{b7}) are
#' compatible with a common intercept / common slope (cics) model, data in
#' Table VI (batches \code{b3}, \code{b4} and \code{b5}) with a different
#' intercept / common slope (dics) model  and data in Table VIII (bathes
#' \code{b4}, \code{b5} and \code{b8}) with a different intercept / different
#' slope (dids) model.
#'
#' @docType data
#' @usage data(exp1)
...
#'
#' @source
#' \href{http://www.ivtnetwork.com/sites/default/files/LinearRegression.pdf}{
#'       LeBlond \emph{et al}., \emph{J Valid Technol} 2011}
#'
#' @examples
#' \dontrun{exp1}
"exp1"
...
#' claim (LC)) of three batches obtained over a 24 months period of a drug
#' product. A total of \eqn{n = 24} independent measurements are available
#' (corresponding to data shown in Table XI in LeBlond \emph{et al}).
#'
#' @docType data
#' @usage data(exp2)
#'
...
#'   \item{Month}{Numeric representing the time points of testing from the
#'                start (0 months) to the end (24 months) of the study.}
#'   \item{Related}{Numeric of the measured related substance level in \%LC}
#' }
#'
#' @references
#' LeBlond, D., Griffith, D. and Aubuchon, K. Linear Regression 102: Stability
...
#' batches obtained over a 24 months period of a drug product. A total of
#' \eqn{n = 33} independent measurements are available (corresponding to data
#' shown in Table XIII in LeBlond \emph{et al}).
#'
#' @docType data
#' @usage data(exp3)
#'
...
#'   \item{Month}{Numeric representing the time points of testing from the
#'                start (0 months) to the end (24 months) of the study.}
#'   \item{Moisture}{Numeric of the measured moisture level \%(w/w)}
#' }
#'
#' @references
#' LeBlond, D., Griffith, D. and Aubuchon, K. Linear Regression 102: Stability
...
#'
#' A data set containing the concentration data (mg/kg) of four batches obtained
#' over a 24 months period of a drug product.  A total of \eqn{n = 36}
...
#' Example data set (Stability.jmp) used in chapter \emph{Stability Analysis},
#' p. 174-176.
#'
#' @source
#' \href{https://support.sas.com/documentation/onlinedoc/jmp/12.0/
