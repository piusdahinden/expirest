...
There is one NOTE that is only found on Windows Server 2022 (64-bit, R-devel):
...
As noted in [R-hub issue #503](https://github.com/r-hub/rhub/issues/503), this could be due to a bug/crash in MiKTeX. It is
not a problem related to expirest.
